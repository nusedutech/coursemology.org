class Assessment::TrainingSubmissionsController < Assessment::SubmissionsController
  ...
  def show
    ...
    if @training.realtime_session_groups.count > 0 and ((@training.close_at and @training.close_at > Time.now) or (@training.bonus_cutoff_at and @training.bonus_cutoff_at > Time.now))
